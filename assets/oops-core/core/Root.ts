 ...
 */
import { _decorator, Component, director, Game, game, Node, profiler, screen, sys } from "cc";
...
export class Root extends Component {
    ...
    private async loadConfig() {
        oops.config.game = new GameConfig(configJson);
        ...
        //@ts-ignore
        oops.gui.initLayer(this.gui, configJson.gui);
